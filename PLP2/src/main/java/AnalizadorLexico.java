...
public class AnalizadorLexico {
    ...
    //Lee tipoToken actual y el caracter que hemos leido
    //y cambia el tipoToken
    private void delta(int c) {
        //System.out.println("\tEstado anterior: "+this.tipoToken);
        switch(this.estado) {
            //Estado base
            case 0:
                //Si es un digito
        ...
        //System.out.println("\tEstado actual: "+this.tipoToken);
    }
    ...
    */
    public Token siguienteToken(){
        ...
        do {
            ...
            //comprobamos el nuevo tipoToken, y lo ponemos en el lexema si corresponde
            char c = siguienteChar();

            //System.out.println("\t\tLeido char "+ c + "("+(int)c+")");
            //Una vez no ha habido error, cambiamos nuestro tipoToken, y comprobamos
            //que no es final
    ...
    private boolean isFinal(Token t) {
        switch(this.estado) {
            ...
            case 13:
                ...
                return true;
            default:
                return this.estado >= 14 && this.estado <= 24;
        }
    }
